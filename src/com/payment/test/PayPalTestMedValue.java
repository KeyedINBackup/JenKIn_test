...
public class PayPalTestMedValue {
	...
	public void Midvalueorder() throws InterruptedException, IOException{
		File file = new File("C:\\Selenium\\jenkindemo\\src\\objectRepositry\\Products_PageObjects");
		FileInputStream input = new FileInputStream(file);
		Properties prop = new Properties();
		prop.load(input);
		dr.navigate().to("http://dev.angelplastics.co.uk/Category/684/Water-Butts-Accessories#");		
		System.out.println("***********************************************************************************************");
		System.out.println("The product name is :Water Butts & Accessories");
		System.out.println("***********************************************************************************************");
		dr.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
