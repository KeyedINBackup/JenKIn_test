...
public class InternalCadding{
	...
	@Test(enabled=true,priority=1)
	  public void NeptuneWallCeilingCladdingProducts() throws IOException, InterruptedException {
		  ...
		  Properties prop = new Properties();
		  prop.load(input);
		  dr.navigate().to(prop.getProperty("InternalCaddingProductPage"));
		  ...
		  dr.findElement(By.xpath(prop.getProperty("NeptuneWall&CeilingCladdingProducts"))).click();
		  ...
		  dr.navigate().to(prop.getProperty("NeptuneWall&CeilingCladdingProductPage"));
	   }
		  dr.navigate().to(prop.getProperty("InternalCaddingProductPage")); 
   }
}