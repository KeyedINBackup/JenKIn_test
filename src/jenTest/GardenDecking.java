...
public class GardenDecking{
	...
	@Test(enabled=true,priority=1)
	  public void TwinsonDeckingProducts() throws IOException, InterruptedException {
		  File file = new File("C:\\Selenium\\jenkindemo\\src\\objectRepositry\\Products_PageObjects");
		  FileInputStream input = new FileInputStream(file);
		  Properties prop = new Properties();
		  prop.load(input);
		  dr.navigate().to(prop.getProperty("GardenDeckingProductpage"));
		  ...
		  dr.findElement(By.xpath(prop.getProperty("TwinsonDeckingProducts"))).click();
	...
	@Test(enabled=true,priority=2)
	  public void NeptuneWallCeilingCladdingProducts() throws IOException, InterruptedException {
		  File file = new File("C:\\Selenium\\jenkindemo\\src\\objectRepositry\\Products_PageObjects");
		  FileInputStream input = new FileInputStream(file);
		  Properties prop = new Properties();
		  prop.load(input);
		  dr.navigate().to(prop.getProperty("GardenDeckingProductpage"));
		  dr.findElement(By.xpath(prop.getProperty("MillboardDeckingProducts"))).click();
		  WebElement Subproductname=dr.findElement(By.xpath(prop.getProperty("subproductname")));
		  String Subproname=Subproductname.getText();
		  System.out.println("***********************************************************************************************");
		  System.out.println("\t\tThe Sub Product Name is:"+Subproname);
		  ...
		  dr.navigate().to(prop.getProperty("MillboardDeckingProductPage"));
	}
} 

	@Test(enabled=true,priority=3)
	  public void GroundGuardLawnPavingTileProducts() throws IOException, InterruptedException {
		  File file = new File("C:\\Selenium\\jenkindemo\\src\\objectRepositry\\Products_PageObjects");
		  FileInputStream input = new FileInputStream(file);
		  Properties prop = new Properties();
		  prop.load(input);
		  dr.navigate().to(prop.getProperty("GardenDeckingProductpage"));
		  dr.findElement(By.xpath(prop.getProperty("GroundGuardLawnPavingTileProducts"))).click();
		  WebElement Subproductname=dr.findElement(By.xpath(prop.getProperty("subproductname")));
		  String Subproname=Subproductname.getText();
		  System.out.println("***********************************************************************************************");
		  System.out.println("\t\tThe Sub Product Name is:"+Subproname);
