...
public class keyWordTest {
  	...
  	public static void FinalSubProductCategories() throws InterruptedException, IOException
  	{
  		...
  		System.out.print("\n");
  		String[] FIsubcatProduct ={"HALF ROUND", "DRILLS & DISCS", "16MM WHITE BULLNOSE FASCIA BOARD", "CAMEL EMBOSSED SHIPLAP", "112MM OGEE CAST GUTTERING", "BLACK RAPIDFLOW", "BLACK STREAMLINE","PUSHFIT /RINGSEAL GREY SOIL","WHITE 62MM SQUARE TERRAIN", "VICTORIAN OGEE", "100MM HALF ROUND CAST GUTTERING","MOULDED NO 46 OG", "125MM X 100MM MOULDED NO 46 LEFTHAND SYSTEM", "BEADED HALF ROUND", "BEADED DEEP FLOW", "CRESCENT", "CORNICHE", "STREAMLINE", "OMEGA"};
  	...
  	public static void FinalSubProductsubCategories() throws InterruptedException, IOException
  	{
  		...
  		System.out.print("\n");
  		String[] FIcatProduct ={"PIPES, BENDS, CONNECTORS & BOSS PIPES", "GREY CRESCENT GUTTERS", "GRAPHITE GREY 7024 HI-CAP GUTTER", "BROWN 65MM SQUARE PIPE", "BLACK XTRAFLO GUTTER SYSTEM", "BROWN RAPIDFLOW GUTTERS", "BRANCHES & ACCESS FITTINGS", "ADAPTORS & REDUCERS", "BRACKETRY & CLIPS"};
